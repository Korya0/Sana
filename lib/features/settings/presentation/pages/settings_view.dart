...
import 'package:sana/features/settings/presentation/cubits/settings_state.dart';
...
class SettingsView extends StatelessWidget {
                  ...
                  return SliverList(
                    delegate: SliverChildListDelegate([
                      ...
                      _QuickTile(
                        ...
                        onTap: () async {
                          await sl<ShareService>().shareText(state.shareText);
                        },
                      ),
  ...
  Future<void> _launchURL(String url) async {
    await sl<LaunchUrlService>().launch(url);
  }
