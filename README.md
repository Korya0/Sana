...
## 🎨 فلسفة التصميم (Premium Experience)

لقد اخترنا التميز من خلال:
- **الوضع الليلي الخالص**: تصميم يريح العين ويعطي طابعاً ملكياً باستخدام اللون الأسود والذهبي.
- **تفاعلات حية**: حركات ناعمة (Animations) تجعل التنقل في التطبيق تجربة ممتعة.
- **التركيز على المحتوى**: واجهات بسيطة بعيدة عن الإعلانات أو المشتتات.
...
*   **Navigation**: GoRouter للتنقل السلس.

---

## 📩 تواصل معنا

نحن نهتم برأيك! يمكنك إرسال اقتراحاتك أو الإبلاغ عن مشكلة مباشرة من داخل التطبيق عبر قسم "تواصل معنا" المرتبط بـ Firebase Firestore.

<div align="center">
تم التطوير بواسطة <b>فريق سنا</b> © 2026
</div>
