...
**آخر تحديث**: 2026-02-27 (إعادة هيكلة ميزة الصلاة (Prayer) وتنظيم المجلدات، تحويل منطق الحسابات إلى Utils مستقلة، وتطوير نظام المناسبات الهجرية لإظهار الأحداث القادمة تلقائياً، وتحديث نظام "فضل الوقت" بأحاديث نبوية منسقة)
